...
//$PAGE->set_pagelayout('tokenlogin');
$PAGE->set_title("Dental Compliance login"); // "$site->fullname: $loginsite");
$PAGE->set_heading("Dental Record Keeping Online Course login"); // "$site->fullname");
...
$detailsqs = optional_param('details', '', PARAM_RAW);
