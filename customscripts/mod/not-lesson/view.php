...
if ($pageid != LESSON_EOL) {
    ...
    $lessoncontent = "<div class='avant-lesson-page-output avant-lesson-page-view'>";
    ...
    $lessoncontent .= "</div>"; //  <div class='avant-lesson-page-output avant-lesson-page-view'>
    ...
    $lessoncontent .= "<div class='lesson-standard-continue'>" . $OUTPUT->single_button($url, get_string('returnto', 'lesson', format_string("Course home", true))) ."</div>";
    // $lessoncontent .= html_writer::link($url, get_string('returnto', 'lesson', format_string("Course home", true)), array('class'=>'centerpadded lessonbutton standardbutton'));
