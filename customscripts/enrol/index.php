...
$alternate_renderer = ($PAGE->theme->name === "classicrenderer");

$strings_origin = $alternate_renderer ? 'theme_' . $PAGE->theme->name : 'enrol';

$PAGE->set_title($course->shortname);
$PAGE->set_heading($course->fullname);
$PAGE->navbar->add(get_string('enrolmentoptions', $strings_origin));

echo $OUTPUT->header();
echo $OUTPUT->heading(get_string('enrolmentoptions', $strings_origin));
...
if ($alternate_renderer) {
    // do nothing
    echo get_string('notenrollable', $strings_origin);
